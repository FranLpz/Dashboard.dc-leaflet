...
dc.leafletMarkerChart = function (parent, chartGroup) {
    ...
    var _marker = function (d, map) {
        ...
        var palet = {
            '1 ambiente':{color: '#dd4b39',fillColor: '#dd4b39'},
            '2 ok':{color: '#00a65a',fillColor: '#f03'},
            '3 baja':{color: '#f39c12',fillColor: '#f03'},
            '4 muy baja':{color: '#00c0ef',fillColor: '#00c0ef'}
        };
        var circle = new L.circle(latlng, 255, {
                    color: palet[lonlatArray[4]].color,
                    fillColor: palet[lonlatArray[4]].color,
    ...
    var _popup = function (d, marker) {
        ...
        var tempe = msg[4].split(" ");
        var t = tempe[2] ? tempe[1]+' '+tempe[2] : tempe[1];
        //return '<p><span class="app-icon icondenuncias-" style="font-size: 22px;">'+msg[2]+'</span>  '+msg[4]+'</p>\n<p>'+msg[3]+'\n</p>'
        return '<p style="color:'+msg[6]+'"><i class="fa fa-truck fa-3x"></i>\n'+msg[5]+'</p>\n<p>'+msg[3]+'</p>\n<p>Temperatura '+t+': '+msg[7]+'°\n</p>'
